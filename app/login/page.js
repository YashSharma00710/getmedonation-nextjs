...
const page = () => {
    ...
    useEffect(() => {
        document.title="Login-GetMeDonation"
    ...
    return (
        <>
            <div className='flex mx-auto my-10 px-30 justify-center max-[630px]:px-20 max-[440px]:px-5'>
                <div className='mt-10 flex flex-col items-center bg-[#ffffff13] backdrop-blur-2xl shadow-[1px_0px_10px_#554483] rounded-2xl  p-6 max-[550px]:p-2'>
                    <h1 className='text-3xl mx-auto px-15 pt-7 text-center max-[550px]:px-5 max-[550px]:text-xl' >Login to GetMeDonation!</h1>
                    <div className="flex flex-col gap-2 p-10 max-[550px]:p-2 max-[550px]:w-full">
                        <button
                            className="flex items-center bg-[#6944d238] text-white rounded-lg border shadow-md max-w-xs px-6 py-2 text-sm font-medium hover:bg-[#aa9fc838] focus:outline-none focus:ring-1 focus:ring-offset-1 focus:ring-gray-500 max-[550px]:w-full max-[550px]:text-[12px] ">
                        ...
                        <button
                            className="flex items-center bg-[#6944d238] text-white rounded-lg border shadow-md max-w-xs px-6 py-2 text-sm font-medium hover:bg-[#aa9fc838] focus:outline-none focus:ring-1 focus:ring-offset-1 focus:ring-gray-500 max-[550px]:w-full max-[550px]:text-[12px]" onClick={() => {
                                signIn("github")
